    ...
    root: cva([
        ...
        variants: {
            intent: {
                ...
                "primary-solid": "text-white bg-indigo-400",
                "success-solid": "text-white bg-green-400",
                "warning-solid": "text-white bg-orange-400",
                "info-solid": "text-white bg-blue-400",
                "alert-solid": "text-white bg-red-400",
                "blue-solid": "text-white bg-blue-400",
                "gray-solid": "text-white bg-gray-400",
