...
export const BadgeAnatomy = defineStyleAnatomy({
    root: cva([
        ...
        variants: {
            intent: {
                "gray": "text-[--foreground] bg-[--subtle] border border-[--border]",
                "primary": "text-[--indigo] bg-indigo-50 border border-indigo-500 border-opacity-40 dark:bg-opacity-10",
                "success": "text-[--green] bg-green-50 border border-green-500 border-opacity-40 dark:bg-opacity-10",
                "warning": "text-[--orange] bg-orange-50 border border-orange-500 border-opacity-40 dark:bg-opacity-10",
                "alert": "text-[--red] bg-red-50 border border-red-500 border-opacity-40 dark:bg-opacity-10",
                "blue": "text-[--blue] bg-blue-50 border border-blue-500 border-opacity-40 dark:bg-opacity-10",
                "indigo": "text-[--indigo] bg-indigo-50 border border-indigo-500 border-opacity-40 dark:bg-opacity-10",
                "info": "text-[--blue] bg-blue-50 border border-blue-500 border-opacity-40 dark:bg-opacity-10",
                "white": "text-[--foreground] bg-[--paper-elevated] border border-[--border]",
                "basic": "text-[--foreground] dark:text-gray-900 bg-transparent",
                "primary-solid": "text-white bg-indigo-700 dark:bg-indigo-500",
                "success-solid": "text-white bg-green-700 dark:bg-green-500",
                "warning-solid": "text-white bg-orange-700 dark:bg-orange-500",
                "info-solid": "text-white bg-blue-700 dark:bg-blue-500",
                "alert-solid": "text-white bg-red-700 dark:bg-red-500",
                "blue-solid": "text-white bg-blue-700 dark:bg-blue-500",
                "gray-solid": "text-white bg-gray-500",
                "zinc-solid": "text-white bg-zinc-500",
                "white-solid": "text-black dark:text-gray-900 bg-white",
