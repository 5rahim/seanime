    ...
    root: cva([
        ...
        variants: {
            intent: {
                ...
                "warning": "shadow-none text-white border bg-orange-700 dark:bg-orange-500 border-orange-400/20 active:bg-opacity-100 dark:bg-opacity-85 dark:hover:bg-opacity-90",
                ...
                "success": "shadow-none text-white border bg-green-700 dark:bg-green-500 border-green-400/20 active:bg-opacity-100 dark:bg-opacity-85 dark:hover:bg-opacity-90",
                ...
                "alert": "shadow-none text-white border bg-red-700 dark:bg-red-500 border-red-400/20 active:bg-opacity-100 dark:bg-opacity-85 dark:hover:bg-opacity-90",
                ...
                "gray-outline": "text-[--muted] border bg-transparent hover:bg-[--subtle] dark:hover:bg-gray-800 dark:hover:bg-opacity-50 active:border-transparent active:bg-[--subtle-highlight] dark:active:bg-gray-700 hover:text-[--foreground] dark:hover:text-gray-100",
                "gray-subtle": "shadow-none text-[--foreground] border border-transparent bg-[--subtle] dark:bg-gray-100 dark:bg-opacity-10 hover:bg-[--subtle-highlight] dark:hover:bg-gray-200 dark:hover:bg-opacity-20 active:bg-[--subtle-highlight] dark:active:bg-gray-300",
                "gray-glass": "shadow-none text-[--foreground] border border-[--border] bg-[--subtle] dark:bg-gray-100 dark:bg-opacity-10 hover:bg-[--subtle-highlight] dark:hover:bg-gray-200 dark:hover:bg-opacity-20 active:bg-[--subtle-highlight] dark:active:bg-gray-300",
                "gray-link": "shadow-none text-[--muted] border border-transparent bg-transparent hover:underline hover:text-[--foreground] dark:hover:text-gray-300 active:text-[--foreground] dark:active:text-gray-200",
                "gray-basic": "shadow-none text-[--muted] border border-transparent bg-transparent hover:bg-[--subtle] dark:hover:bg-gray-100 dark:hover:bg-opacity-10 hover:text-[--foreground] dark:hover:text-gray-200 active:bg-[--subtle-highlight] dark:active:bg-gray-200 dark:active:bg-opacity-20",
                ...
                "white-subtle": "shadow-none text-[--foreground] bg-[--subtle] dark:bg-white dark:bg-opacity-15 hover:bg-[--subtle-highlight] dark:hover:bg-opacity-20 border border-transparent active:bg-[--subtle-highlight] dark:active:bg-opacity-25",
                "white-glass": "shadow-none text-[--foreground] bg-[--subtle] dark:bg-white dark:bg-opacity-15 hover:bg-[--subtle-highlight] dark:hover:bg-opacity-20 border border-[--border] active:bg-[--subtle-highlight] dark:active:bg-opacity-25",
                "white-link": "shadow-none text-[--foreground] border border-transparent bg-transparent hover:underline active:text-[--muted] dark:active:text-gray-200",
                "white-basic": "shadow-none text-[--foreground] border border-transparent bg-transparent hover:bg-[--subtle] dark:hover:bg-white dark:hover:bg-opacity-15 active:bg-[--subtle-highlight] dark:active:bg-white dark:active:bg-opacity-20",
            },
            rounded: {
                true: "rounded-full",
                false: null,
