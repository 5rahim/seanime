...
import { useRefreshAnilistCollection } from "@/lib/server/hooks/media"
...
export const RefreshAnilistButton: React.FC<RefreshAnilistButtonProps> = (props) => {
    ...
    const { refreshAnilistCollection, isPending } = useRefreshAnilistCollection()

    return (
        <>
            <Button
                onClick={() => refreshAnilistCollection()}
