export const enum SeaEndpoints {
    ...
    ANIME_ENTRY = "/library/anime-entry/{id}", // (GET)
    ANIME_ENTRY_SUGGESTIONS = "/library/anime-entry/suggestions", // (POST)
    ANIME_ENTRY_MANUAL_MATCH = "/library/anime-entry/manual-match", // (POST)
    ANIME_ENTRY_BULK_ACTION = "/library/anime-entry/bulk-action", // (PATCH)
    OPEN_ANIME_ENTRY_IN_EXPLORER = "/library/anime-entry/open-in-explorer", // (POST)
    LIBRARY_UNKNOWN_MEDIA = "/library/unknown-media", // (POST)
    ANIME_ENTRY_SILENCE_STATUS = "/library/anime-entry/silence/{id}", // (GET)
    ANIME_ENTRY_UPDATE_PROGRESS = "/library/anime-entry/update-progress", // (POST)
    ANIME_ENTRY_SILENCE = "/library/anime-entry/silence", // (POST)
