                    ...
                    <div className="">
                        <Form
                            ...
                            onSubmit={data => {
                                mutate({
                                    ...
                                    mediaPlayer: {
                                        ...
                                        jellyfinServerUrl: data.jellyfinServerUrl || "",
                            ...
                            defaultValues={{
                                ...
                                jellyfinServerUrl: status?.settings?.mediaPlayer?.jellyfinServerUrl ?? "",
                                jellyfinApiKey: status?.settings?.mediaPlayer?.jellyfinApiKey ?? "",
                                jellyfinUserId: status?.settings?.mediaPlayer?.jellyfinUserId ?? "",
