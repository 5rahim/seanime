...
function CalendarDayBackground({ events, isToday, hoveredEventId }: CalendarDayBackgroundProps) {
    ...
    return (
        <>
            <div
                className={`absolute top-0 left-0 z-[0] w-full h-full overflow-hidden transition-all duration-500 ease-out ${
    ...
    return (
        <div
            ...
            className={cn(
                ...
                "relative py-2 px-3 h-40 overflow-hidden rounded-md",
        ...
        >
            ...
            <div className="absolute top-1 left-1 right-1 z-[2] pointer-events-none">
                <div
                    className={cn(
                ...
                >
                    {hoveredEvent && (
                        <div className="bg-gray-900/90 backdrop-blur-sm rounded-md px-2 py-1 border border-gray-700/50">
