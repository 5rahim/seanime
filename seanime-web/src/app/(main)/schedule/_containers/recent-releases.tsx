                        ...
                        return (
                            <MediaEntryCard
                                ...
                                overlay={<div className="flex flex-col w-fit absolute right-0 items-end">
                                    <div
                                        className="font-semibold text-[--foreground] bg-gray-950 z-[1] pl-3 pr-[0.2rem] w-full py-1.5 text-center !tracking-wider !bg-opacity-80 rounded-none rounded-bl-lg"
