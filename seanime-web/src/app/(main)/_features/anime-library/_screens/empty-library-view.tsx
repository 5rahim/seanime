    ...
    return (
        <HorizontalDraggableScroll className="scroll-pb-1 pt-4 flex">
            ...
            <StaticTabs
                ...
                triggerClass="text-base rounded-[--radius-md] ring-2 ring-transparent data-[current=true]:ring-brand-500 data-[current=true]:text-[--brand] dark:data-[current=true]:text-brand-300"
                items={[
                    // {
                    //     name: "All",
