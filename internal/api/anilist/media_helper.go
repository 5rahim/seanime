...
func (m *CompleteMedia) FindEdge(relation string, formats []MediaFormat) (*BasicMedia, bool) {
...
func (m *BaseMedia) ToBasicMedia() *BasicMedia {
	...
	var trailer *BasicMedia_Trailer
	if m.GetTrailer() != nil {
		trailer = &BasicMedia_Trailer{
	...
	var nextAiringEpisode *BasicMedia_NextAiringEpisode
	...
	var startDate *BasicMedia_StartDate
	...
	var endDate *BasicMedia_EndDate
	if m.GetEndDate() != nil {
		endDate = &BasicMedia_EndDate{
...
func (m *CompleteMedia) ToBasicMedia() *BasicMedia {
	if m == nil {
		return nil
	}
