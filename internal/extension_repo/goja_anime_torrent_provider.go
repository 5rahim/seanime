...
func NewGojaAnimeTorrentProvider(ext *extension.Extension, language extension.Language, logger *zerolog.Logger) (hibiketorrent.AnimeProvider, error) {
   ...
   return new Provider()
	...
	return &GojaAnimeTorrentProvider{
