...
func TestLocalFile_GetNormalizedPath(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.filePath, func(t *testing.T) {
			lf := entities.NewLocalFile(tt.filePath, tt.libraryPath)
...
func TestLocalFile_Equals(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.filePath1, func(t *testing.T) {
			lf1 := entities.NewLocalFile(tt.filePath1, tt.libraryPath)
			lf2 := entities.NewLocalFile(tt.filePath2, tt.libraryPath)
