...
/**
 * Filepath: internal/docs/generate_docs.go
 * Filename: generate_docs.go
 * Package: docs
 */
export type INTERNAL_Docs = {
    routeGroups?: Array<INTERNAL_RouteGroup>
}
 ...
 * Package: docs
 */
export type INTERNAL_RequestBodyFields = {
    name: string
    type: string
    description: string
}
 ...
 * Package: docs
 */
export type INTERNAL_Route = {
    name: string
    summary: string
    description: string
    methods?: Array<string>
    endpoint: string
    params?: Array<INTERNAL_Param>
    requestBodyFields?: Array<INTERNAL_RequestBodyFields>
    returns: string
}
 ...
 * Package: docs
 */
export type INTERNAL_RouteGroup = {
    filename: string
    routes?: Array<INTERNAL_Route>
}
