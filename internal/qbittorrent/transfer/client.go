...
func (c Client) GetTransferInfo() (*qbittorrent_model.TransferInfo, error) {
	...
	if err := qbittorrent.GetInto(c.Client, &res, c.BaseUrl+"/info", nil); err != nil {
		return nil, err
	}
	return &res, nil
}
...
func (c Client) AlternativeSpeedLimitsEnabled() (bool, error) {
	var res int
	if err := qbittorrent.GetInto(c.Client, &res, c.BaseUrl+"/speedLimitsMode", nil); err != nil {
		return false, err
	}
	return res == 1, nil
}
...
func (c Client) ToggleAlternativeSpeedLimits() error {
	if err := qbittorrent.Post(c.Client, c.BaseUrl+"/toggleSpeedLimitsMode", nil); err != nil {
		return err
	}
	return nil
}
...
func (c Client) GetGlobalDownloadLimit() (int, error) {
	var res int
	if err := qbittorrent.GetInto(c.Client, &res, c.BaseUrl+"/downloadLimit", nil); err != nil {
		return 0, err
	}
	return res, nil
}
...
func (c Client) GetGlobalUploadLimit() (int, error) {
	var res int
	if err := qbittorrent.GetInto(c.Client, &res, c.BaseUrl+"/uploadLimit", nil); err != nil {
		return 0, err
	}
	return res, nil
}
